...
const ENGINE_BARREL_RUNTIME_EXPORTS = [
  ...
  'advanceToDay', 'alignmentOf', 'alive', 'aliveCount', 'aliveNeighbours', 'answersAtSeq',
  'applyVirgin', 'assignRoles', 'autoSkipUnmetSteps', 'beginFirstNight', 'beginNight', 'butlerViolations',
